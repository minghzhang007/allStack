...
public class BinaryTest {
    ...
    public static void justTest(){
        ...
        String s = BinaryUtil.getBinaryString(binaryString);
        System.out.println(s);

        byte i = (byte) ((number >> 24) & 0xff);
        System.out.println(BinaryUtil.getBinaryString(Integer.toBinaryString(i)));

        byte j = (byte)((number >> 16) & 0xff);
        System.out.println(BinaryUtil.getBinaryString(Integer.toBinaryString(j)));

        byte l = (byte)((number >> 8) & 0xff);
        System.out.println(BinaryUtil.getBinaryString(Integer.toBinaryString(l)));

        byte k = (byte)((number) & 0xff);
        System.out.println(BinaryUtil.getBinaryString(Integer.toBinaryString(k)));
        byte[] a = int2Bytes(number);
        System.out.println(Arrays.toString(a));
        System.out.println();
        System.out.println();
        for (byte b : a) {
            System.out.println(BinaryUtil.getBinaryString(Integer.toBinaryString(b)));
        }
